<template>
    <div class="registration-form-container">
      ...
      <form @submit.prevent="handleSubmit" class="registration-form">
        ...
        <AppButton type="submit" :buttonId="'registerButton'" :buttonText="'Register'" :styleClass="['m-3','nvi-btn', 'nvi-btn-primary']" ></AppButton>
      </form>
      <p class="mt-5, m-4">Already registered? </p>
      <!---TODO style btn-wide and set @click to route to login:-->
      <AppButton :buttonId="'toLoginBtn'" :buttonText="'Log in'" :styleClass="['nvi-btn', 'nvi-btn-secondary', 'nvi-btn-wide']" ></AppButton>
  ...
  visibility: hidden; /** Until pages are implemented */
  max-width: 500px;
  margin: 0 auto;
  padding: 20px;
